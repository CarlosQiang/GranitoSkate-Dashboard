...
import { Loader2, Plus, Eye, Edit, AlertTriangle, RefreshCw, Percent } from "lucide-react"
            ...
            <CardContent className="space-y-4">
              ...
              {promocion.limite_uso && (
                <div className="flex justify-between items-center text-sm">
                  ...
                  <span>
                    {promocion.contador_uso || 0} / {promocion.limite_uso}
                  </span>
                </div>
              )}
