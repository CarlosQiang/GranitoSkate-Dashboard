        ...
        <div className="flex flex-col space-y-6">
          ...
          <div className="flex flex-col space-y-4">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">Bienvenido al panel de administración de GranitoSkate</p>
            </div>
            <Button onClick={loadDashboardData} className="w-full sm:w-auto self-start">
              ...
              <CardContent className="pt-4 flex items-start">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-xs text-amber-700 mt-1">
                    Los datos pueden estar incompletos. Puedes intentar actualizar o continuar con los datos
                    disponibles.
                  </p>
                </div>
              </CardContent>
          ...
          <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
            <Card className="w-full">
              ...
              <CardContent>
                ...
                <p className="text-xs text-gray-500">+0% desde el mes pasado</p>
              </CardContent>
            </Card>
          ...
          <div className="grid gap-4 grid-cols-1 xl:grid-cols-7">
            <Card className="xl:col-span-4 w-full">
              <CardHeader>
