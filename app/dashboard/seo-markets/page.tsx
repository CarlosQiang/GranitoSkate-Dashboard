  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">SEO para Mercados</h1>
      ...
      <div className="p-6 bg-yellow-50 border border-yellow-200 rounded-md">
        ...
        <p className="text-yellow-700">
          La gestión de SEO para mercados está temporalmente deshabilitada mientras actualizamos nuestro sistema. Por
